CL_1 Build a Mini Research Dataset (Windows / Git Bash Edition) 
===============================================================
...
1️⃣ Open Git Bash: 🔍 Start Menu Search > Git Bash > Enter
...
3️⃣ Read your prompt: Look at the text before your cursor in Git Bash.

💡 Why: It usually shows something like: "[yourname]@DESKTOP-ABC123 ~"

✨ Tip: If you see ~ as the last part, that means you are in your home directory, which is the start of every path.
...
✨ Tip: If you have successfully moved to your desktop, then the prompt you see before your cursor should include Desktop. If you want to check where you are, enter the command pwd and then enter the command ls to see all the files and folders on your desktop. You should see the CL_1 folder listed.
